...
<div class="form-group">
 ...
 <?= CHtml::activeHiddenField($user, 'id', array('class' => 'form-control',)) ?>
        <p><?= CHtml::submitButton('Сохранить', array('id' => "submit", 'class' => 'btn btn-info btn-xs', 'style' => 'background-color: #61A3CB;')); ?></p>

<?= CHtml::endForm(); ?>
        <p><?= CHtml::link('Изменить пароль', array('user/chPass/id/'.$user['id']), array('class' => 'btn btn-info btn-xs', 'style' => '    background: #61A3CB;')); ?></p>
</div>
